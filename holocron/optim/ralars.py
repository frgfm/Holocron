...
class RaLars(Optimizer):
    ...
    Args:
        ...
        force_adaptive_momentum (float, optional): should the momentum be adaptive if variance is not tractable (default: False)
            ...
            for p in group['params']:
                ...
                if sma_t > 4:
                    ...
                    if self.force_adaptive_momentum:
                        ...
                        update.addcdiv_(1, exp_avg / bias_correction1, (exp_avg_sq / bias_correction2).sqrt().add_(group['eps']))
                    else:
                        # Unadapted momentum
